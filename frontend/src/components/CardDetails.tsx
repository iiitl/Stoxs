...
function CardDetails() {
    ...
    const handleGetTotalValue = async () => {
        try {
            const res = await fetch(`${import.meta.env.URL}/api/portfolio/total-value`)
    ...
    const handleGetTopPerforming = async () => {
        try {
            const res = await fetch(`${import.meta.env.URL}/api/portfolio/top-performing`)
            const data = await res.json()
    ...
    const handleGetMarketStatus = async () => {
        try {
            const res = await fetch(`${import.meta.env.URL}/api/stocks/US/market-status`)
            const data = await res.json()
